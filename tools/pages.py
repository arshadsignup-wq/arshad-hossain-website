...
_CASES = [
    ...
    ("wardrobe-eid-adha",    "12,813 Messenger Conversations at $0.04 Each (Eid ul Adha)",
     "A Messenger Ads campaign for a Bangladeshi fashion brand: 12,813 message conversions for $576.51, four cents per conversation, 514,208 people reached."),
    ("wardrobe-eid-message", "$0.03 Per Messenger Conversation Across 16 Creatives",
     "A Messenger Ads campaign averaging $0.03 per conversation, best ad set at $0.02, reaching 225,566 people on $135.49 of spend across 16 creatives and 4 ad sets."),
    ("wardrobe-conversion",  "121 Purchases at $0.71 Each: Facebook Conversion Ads",
     "Facebook conversion campaigns producing 121 website purchases at $0.71 average — tote bags at $0.32 and t-shirts at $0.82 — for a Bangladeshi fashion brand."),
    ("wardrobe-reel",        "333,110 Reel Views, 96% Non-Followers, 40,000 Tk Extra Sales",
     "An organic seasonal Reel that reached 333,110 views with 96% of the audience non-followers, and drove 40,000 Tk of additional outlet sales in two days."),
